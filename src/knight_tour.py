...
def extract_solution(solver, M, N, T, var):
    res = False
    # Solving and extracting information to solution
    ...
    return solution, solver, var, res
...
"""
def solve_knight_tour(M, N, i0, j0, mode='n'):
    ...
    solution, solver, var, res = extract_solution(solver, M, N, T, var)
